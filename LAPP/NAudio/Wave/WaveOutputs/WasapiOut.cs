using LAPP.NAudio.CoreAudioApi;
using System;
...
namespace LAPP.NAudio.Wave
{
    ...
    public class WasapiOut : IWavePlayer, IWavePosition
    {
        ...
        private static MMDevice GetDefaultAudioEndpoint()
        {
            ...
            {
                throw new NotSupportedException("WASAPI supported only on Windows Vista or above");
            }
                ...
                while (playbackState != PlaybackState.Stopped)
                {
                    ...
                    if (playbackState == PlaybackState.Playing || playbackState == PlaybackState.Paused)
                    {
                        if (indexHandle != WaitHandle.WaitTimeout)
                        {
                            ...
                            if (numFramesAvailable > 10) // see https://LAPP.NAudio.codeplex.com/workitem/16363
                            {
