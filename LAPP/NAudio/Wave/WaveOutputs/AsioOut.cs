...
namespace LAPP.NAudio.Wave
{
    ...
    public class AsioOut : IWavePlayer
    {
        ...
        /// n.b. Future LAPP.NAudio may modify this
        /// </summary>
        ...
        /// </summary>
        [Obsolete("this function will be removed in a future LAPP.NAudio as ASIO does not support setting the volume on the device")]
        public float Volume
        {
            get
            {
