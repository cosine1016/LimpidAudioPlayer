...
namespace LAPP.NAudio.Wave.Compression
{
    /// <summary>
    ...
    internal class AcmInterop
    {
        ...
        public static extern MmResult acmFormatSuggest(
            IntPtr hAcmDriver,
            [In, MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "LAPP.NAudio.Wave.WaveFormatCustomMarshaler")]
            WaveFormat sourceFormat,
            [In, Out, MarshalAs(UnmanagedType.CustomMarshaler, MarshalType = "LAPP.NAudio.Wave.WaveFormatCustomMarshaler")]
