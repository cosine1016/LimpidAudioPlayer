using LAPP.NAudio.Wave.SampleProviders;
using System;

namespace LAPP.NAudio.Wave
{
    /// <summary>
    /// AudioFileReader simplifies opening an audio file in LAPP.NAudio
    ...
    public class AudioFileReader : WaveStream, ISampleProvider
    {
        ...
        /// <summary>
        /// Creates the reader stream, supporting all filetypes in the core LAPP.NAudio library,
        /// and ensuring we are in PCM format
        /// </summary>
        /// <param name="fileName">File Name</param>
        protected virtual void CreateReaderStream(string fileName)
        {
